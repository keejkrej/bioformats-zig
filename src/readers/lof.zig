...
test "matches Bio-Formats plane hash for cached LOF fixture" {
    ...
    const expected_region = [_]u8{ 0xf6, 0x12, 0xf8, 0xec, 0x8c, 0x83, 0x44, 0x89, 0x35, 0x8a, 0xac, 0xb9, 0xf1, 0x77, 0x1b, 0x9e, 0xe5, 0x2f, 0x13, 0x67, 0x9a, 0x98, 0xde, 0x0f, 0xed, 0x07, 0x9f, 0xd6, 0xa5, 0xc9, 0x44, 0x31 };
