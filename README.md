...
- Olympus OIR files are detected from `OLYMPUSRAWFORMAT`, interspersed XML blocks provide dimensions, and raw pixel blocks are assembled into scalar planes; tiled plane assembly, external `.oir` companion chunks, LUTs, physical sizes, timestamps, and instrument metadata are not yet surfaced.
