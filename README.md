...
- LI-FLIM `.fli` files with embedded version 1/2 headers, uncompressed or gzip-compressed 8/16/32-bit integer or 32/64-bit floating-point little-endian planes, and uncompressed packed 12-bit data expanded to uint16; background/dark image series, ROI overlays, timestamps, and exposure metadata are not yet handled.
